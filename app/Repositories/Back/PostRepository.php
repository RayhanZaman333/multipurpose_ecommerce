...
class PostRepository
{
    ...
    public function delete($post)
    {
        ...
        foreach($images as $image){
            if (file_exists(base_path('../').'storage/images/'.$image)) {
                unlink(base_path('../').'storage/images/'.$image);
            }
        }
        $post->delete();
    }
    ...
    public function photoDelete($key,$id)
    {
        ...
        if (file_exists(base_path('../').'storage/images/'.$delete_photo)) {
            unlink(base_path('../').'storage/images/'.$delete_photo);
        }
