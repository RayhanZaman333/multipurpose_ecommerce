    ...
    <div class="card card-body p-5">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="{{route('user.order.print',$order->id)}}" target="_blank" class="btn btn-sm btn-primary invoice_price d-inline-block"><span>{{__('Print Invoice')}}</span></a>
                    </div>
                </div> <!-- / .row -->
                <div class="row">
                  <div class="col text-center">
                    ...
                    <!-- Logo -->
                    <img class="img-fluid mb-5 mh-70"  alt="Logo" src="{{asset('storage/images/'.$setting->logo)}}">
