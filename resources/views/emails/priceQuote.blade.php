...
xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <head>
        ...
        <!--<![endif]-->
        <title>Price Quotation Mail</title>
                                        ...
                                        <div style="width: 100% !important;">
                                            ...
                                            <div
                                                ...
                                                <table style="font-family:'Lato',sans-serif;" role="presentation"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 5px;font-family:'Lato',sans-serif;"
                                                                align="left">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%; text-align: center;">
                                                                        <span style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">{{ $setting->title }} </span>
                                                                    </p>
                                                                </div>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Dear Concern, </span>
                                                                    </p>
