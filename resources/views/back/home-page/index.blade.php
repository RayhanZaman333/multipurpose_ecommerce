                            ...
                            <form class="admin-form" action="{{route('back.hero.banner.update')}}"method="POST" enctype="multipart/form-data">
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{isset($hero_banner['img1']) ? asset('storage/images/'.$hero_banner['img1']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{isset($hero_banner['img2']) ? asset('storage/images/'.$hero_banner['img2']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$first_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$first_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$first_banner['img3']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.secend.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$secend_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$secend_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$secend_banner['img3']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.third.banner.update')}}"
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$third_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('storage/images/'.$third_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.home_page4.banner.update')}}"method="POST" enctype="multipart/form-data">
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img1']) ?  asset('storage/images/'.$home4_banner['img1']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img2']) ?  asset('storage/images/'.$home4_banner['img2']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img3']) ?  asset('storage/images/'.$home4_banner['img3']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img4']) ?  asset('storage/images/'.$home4_banner['img4']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img5']) ?  asset('storage/images/'.$home4_banner['img5']) : asset('storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
