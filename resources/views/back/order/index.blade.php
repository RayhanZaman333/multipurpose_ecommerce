          ...
          <div class="row mb-4 justify-content-center">
            <div class="col-md-6 col-sm-6 col-lg-4">
              <div class="form-group p-0">
                ...
                <input type="text" name="start_date" id="datepicker" class="form-control datepicker" id="start_date" placeholder="{{ __('Start Date') }}" value="">
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-4">
              <div class="form-group  p-0">
                ...
                <input type="text" name="end_date" id="datepicker1" class="form-control datepicker" id="end_date" placeholder="{{ __('End Date') }}" value="">
              </div>
            </div>
        ...
        <div class="orderBtn">
          <div class="row mb-4 justify-content-center">
            <div class="col-lg-12 text-center">
              <a href="{{ route('back.order.index').'?type='.'Pending' }}" class="btn btn-primary py-1 mr-2">{{ __('Pending Orders') }}</a>

              <a href="{{ route('back.order.index').'?type='.'In Progress' }}" class="btn btn-info py-1 mr-2">{{ __('Progress Orders') }}</a>

              <a href="{{ route('back.order.index').'?type='.'Delivered' }}" class="btn btn-success py-1 mr-2">{{ __('Delivered Orders') }}</a>

              <a href="{{ route('back.order.index').'?type='.'Canceled' }}" class="btn btn-danger py-1 mr-2">{{ __('Canceled Orders') }}</a>
            </div>
          </div>
        </div>
