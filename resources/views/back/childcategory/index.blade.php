		...
		<div class="card mb-4">
			<div class="card-body">
				<div class="d-sm-flex align-items-center justify-content-between">
					<h3 class="mb-0 bc-title"><b>{{ __('Child Categories') }}</b></h3>

					<a href="{{ route('back.childcategory.create') }}" class="btn btn-sm btn-primary" > <i class="fas fa-plus"></i> {{ __('Add New Child Category') }} </a>
				</div>
			</div>
		</div>
		{{-- Create Table Btn --}}
