                            ...
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <p class="bg-danger badge text-white">Unverified</p>
                                        @endif
                                    </td>

                                    <td class="text-center">
                                        <div class="action-list">
                                            <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirm-delete" href="javascript:;" data-href="{{ route('back.subscriber.delete', $data->id) }}">
