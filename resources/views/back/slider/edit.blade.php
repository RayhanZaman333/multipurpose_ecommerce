						...
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.slider.update',$slider->id) }}"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $slider->logo ? asset('storage/images/'.$slider->logo) : asset('storage/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $slider->photo ? asset('storage/images/'.$slider->photo) : asset('storage/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
