                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-12 pb-1">
                                                                            <img class="admin-setting-img my-mw-100"
                                                                                src="{{ $setting->favicon ? asset('storage/images/'.$setting->favicon) : asset('storage/images/placeholder.png') }}"
                                                                                alt="No Image Found">
                                                                        </div>
                                                            ...
                                                            <div class="row justify-content-center">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-lg-12 pb-1">
                                                                            <img class="admin-setting-img my-mw-100"
                                                                                src="{{ $setting->loader ? asset('storage/images/'.$setting->loader) : asset('storage/images/placeholder.png') }}"
                                                                                alt="No Image Found">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group position-relative ">
                                                        ...
                                                        <div class="row justify-content-center">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-12 pb-1">
                                                                        <img class="admin-setting-img"
                                                                            src="{{ $setting->footer_gateway_img ? asset('storage/images/'.$setting->footer_gateway_img) : asset('storage/images/placeholder.png') }}"
                                                                            alt="No Image Found">
                                                                    </div>
