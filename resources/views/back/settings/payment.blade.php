                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12 pb-1">
                                                                    <img class="admin-setting-img"
                                                                        src="{{ $cod->photo ? asset('storage/images/'.$cod->photo) : asset('storage/images/placeholder.png') }}"
                                                                        alt="No Image Found">
                                                                </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $stripe->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $stripe->photo ? asset('storage/images/'.$stripe->photo) : asset('storage/images/placeholder.png') }}"
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $paypal->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $paypal->photo ? asset('storage/images/'.$paypal->photo) : asset('storage/images/placeholder.png') }}"
                                                                    alt="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $molly->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $molly->photo ? asset('storage/images/'.$molly->photo) : asset('storage/images/placeholder.png') }}"
                                                                    alt="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $paytm->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $paytm->photo ? asset('storage/images/'.$paytm->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $sslcommerz->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $sslcommerz->photo ? asset('storage/images/'.$sslcommerz->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $mercadopago->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $mercadopago->photo ? asset('storage/images/'.$mercadopago->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $authorize->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $authorize->photo ? asset('storage/images/'.$authorize->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $paystack->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $paystack->photo ? asset('storage/images/'.$paystack->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $bank->status == 1 ? '' : 'd-none' }}">
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $bank->photo ? asset('storage/images/'.$bank->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $razorpay->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $razorpay->photo ? asset('storage/images/'.$razorpay->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="image-show {{ $flutterwave->status == 1 ? '' : 'd-none' }}">
                                                        ...
                                                        <div class="form-group col-xl-12">
                                                            ...
                                                            <div class="col-lg-12 pb-1">
                                                                <img class="admin-setting-img"
                                                                    src="{{ $flutterwave->photo ? asset('storage/images/'.$flutterwave->photo) : asset('storage/images/placeholder.png') }}"
                                                                    stripe="No Image Found">
                                                            </div>
                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                        </div>
