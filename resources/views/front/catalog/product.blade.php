      ...
      <div class="col-xxl-5 col-lg-6 col-md-6">
        ...
        <div class="product-thumbnails insize">
          <div class="product-details-slider owl-carousel" >
            <div class="item"><img src="{{ asset('storage/images/'.$item->photo) }}" alt="zoom"/></div>

            @foreach ($galleries as $key => $gallery)
              <div class="item"><img src="{{ asset('storage/images/'.$gallery->photo) }}" alt="zoom"/></div>
            @endforeach
          </div>
        </div>
      </div>
      ...
      <div class="col-md-8">
        @forelse ($reviews as $review)
          <div class="single-review">
            <div class="comment">
              <div class="comment-author-ava"><img class="lazy" data-src="{{ asset('storage/images/'.$review->user->photo) }}" alt="Comment author"></div>
