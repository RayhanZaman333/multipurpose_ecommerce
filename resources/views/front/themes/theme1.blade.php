                    ...
                    @if (isset($hero_banner))
                        <div class="col-lg-4 d-none d-lg-block">
                            <a href="{{ $hero_banner['url1'] }}" class="sright-image">
                                <img src="{{ asset('storage/images/'.$hero_banner['img1']) }}" alt="">
                            ...
                            <a href="{{$hero_banner['url2']}}" class="sright-image mb-0">
                                <img src="{{ asset('storage/images/'.$hero_banner['img2']) }}" alt="">
                                ...
                                <div class="slider-item">
                                    <div class="product-card">
                                        <div class="product-thumb">
                                            ...
                                            @if ($compaign_item->item->is_price_show == 1)
                                ...
                                <div class="slider-item">
                                    <div class="product-card">
                                        <div class="product-thumb">
                                            ...
                                            @if ($popular_category_item->is_price_show == 1)
                                            ...
                                            @foreach ($two_column_category_itemt as $two_column_category_item)
                                                <div class="product-card p-col">
                                                    <a class="product-thumb" href="{{route('front.product', $two_column_category_item->slug)}}">
                                                        ...
                                                        <img class="lazy" data-src="{{ asset('storage/images/'.$two_column_category_item->thumbnail) }}" alt="Product">
                                                    </a>
                                                    ...
                                                    <div class="product-card-body">
                                                        ...
                                                        @if($two_column_category_item->is_price_show == 1)
                                                            <h4 class="product-price">
                        ...
                        <div class="col-gd">
                            <div class="product-card">
                                <div class="product-thumb">
                                    ...
                                    @if($feature_category_item->is_price_show == 1)
        ...
        <div class="blog-section-h page_section mt-50 mb-30">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h2 class="h3">{{ __('Our Solutions') }}</h2>
                        </div>
                    </div>
                </div>
