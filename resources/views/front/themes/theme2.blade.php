                                    ...
                                    <div class="col-lg-8">
                                        <div class="item-inner">
                                            <div class="from-bottom">
                                                @if ($slider->logo)
                                                    <img class="d-inline-block brand-logo" src="{{ asset('storage/images/' . $slider->logo) }}" alt="logo">
                                                @endif
                        ...
                        <div class="main-content">
                            <div class="flash-deal-slider owl-carousel">
                                @foreach ($products->orderBy('id', 'DESC')->get() as $item)
                                    @if (($item->is_type == 'flash_deal') && ($item->date != null) && (date('d-m-y') <= \Carbon\Carbon::parse($item->date)->format('d-m-y')))
                                        <div class="slider-item">
                                            <div class="product-card ">
                                                <div class="product-thumb">
                                                    ...
                                                    <img class="lazy" data-src="{{ asset('storage/images/' . $item->thumbnail) }}" alt="Product" style="height: 250px; width: 250px;">
                                                ...
                                                <div class="product-card-inner">
                                                    <div class="product-card-body">
                                                        ...
                                                        <h3 class="product-title">
                                                            <a href="{{ route('front.product', $item->slug) }}">{{ Str::limit($item->name, 50) }}</a>
                                                        </h3>
                                        ...
                                        <div class="product-card ">
                                            ...
                                            <div class="product-card-inner">
                                                <div class="product-card-body">
                                                    ...
                                                    <h3 class="product-title">
                                                        <a href="{{ route('front.product', $item->slug) }}">{{ Str::limit($item->name, 35) }}</a>
                                                    </h3>
                                            ...
                                            @foreach ($two_column_category_itemt as $two_column_category_item)
                                                <div class="product-card p-col">
                                                    <a class="product-thumb" href="{{ route('front.product', $two_column_category_item->slug) }}">
                                                        ...
                                                        <img class="lazy" data-src="{{ asset('storage/images/' . $two_column_category_item->thumbnail) }}" alt="Product" style="height: 250px; width: 250px;">
                                                    </a>
                            ...
                            @foreach ($brands as $brand)
                                <div class="slider-item">
                                    <a class="text-center"href="{{ route('front.catalog') . '?brand=' . $brand->slug }}">
                                        <img class="d-block hi-50 lazy" data-src="{{ asset('storage/images/' . $brand->photo) }}" alt="{{ $brand->name }}" title="{{ $brand->name }}">
                                    </a>
                                </div>
                            @endforeach
                        </div>
