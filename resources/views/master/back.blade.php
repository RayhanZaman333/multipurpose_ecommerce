            ...
            <div class="main-header ">
                ...
                <div class="logo-header">
                    <a href="{{ route('back.dashboard') }}" class="logo">
                        <img src="{{ $setting->logo ? asset('storage/images/' . $setting->logo) : asset('storage/images/placeholder.png') }}" alt="navbar brand" class="navbar-brand">
                    </a>
                            ...
                            <li class="nav-item dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="{{ route('back.dashboard') }}" aria-expanded="false">
                                    <div class="avatar-sm avatar avatar-sm">
                                        <img src="{{ Auth::guard('admin')->user()->photo ? asset('storage/images/' . Auth::guard('admin')->user()->photo) : asset('storage/images/noimage.png') }}" alt="..." class="avatar-img rounded-circle">
                                    </div>
                                </a>
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="{{ Auth::guard('admin')->user()->photo ? asset('storage/images/' . Auth::guard('admin')->user()->photo) : asset('storage/images/noimage.png') }}" alt="image profile" class="avatar-img rounded"></div>
