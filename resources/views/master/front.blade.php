                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="site-branding">
                                    <a class="site-logo align-self-center" href="{{ route('front.index') }}">
                                        <img src="{{ asset('storage/images/'.$setting->logo) }}" alt="{{ $setting->title }}">
                                    </a>
                                </div>
                                    ...
                                    <a href="{{ route('fornt.compare.index') }}">
                                        <div>
                                            <span class="compare-icon">
                                                ...
                                                <span class="count-label compare_count">{{ Session::has('compare') ? count(Session::get('compare')) : '0' }}</span>
                                            </span>
                                        ...
                                        <a href="{{ route('user.wishlist.index') }}">
                                            <div>
                                                <span class="compare-icon">
                                                    ...
                                                    <span class="count-label wishlist_count">{{ Auth::user()->wishlists->count() }}</span>
                                                </span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <section class="widget">
                            ...
                            <div class="pt-3"><img class="d-block gateway_image" src="{{ $setting->footer_gateway_img ? asset('storage/images/'.$setting->footer_gateway_img) : asset('system/resources/storage/images/placeholder.png') }}"></div>
                        </section>
                    </div>
                </div>
